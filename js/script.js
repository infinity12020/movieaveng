...
let backg = document.querySelector(".promo__bg");

backg.style.background = `url("./img/bg.jpg") no-repeat center / cover`;
...
function GanrsUpdate(arr, place) {
  for (let item of arr) {
